...
const SolutionCard = ({ title, description, image }: solutionCard) => {
  return (
    <div className='group relative  w-80 rounded-2xl shadow-2xl transition-all overflow-hidden'>
      ...
      <div className='absolute -bottom-18 px-4 group-hover:bottom-10 transition-discrete duration-500 ease-in-out' >
