      ...
      <div className='container flex flex-col justify-between items-center gap-8 sm:flex-row w-full h-full'>
        <div className='flex flex-col gap-4'>
          ...
          <div className='flex sm:flex-row flex-col gap-4 sm:gap-8'>
            {content.statistics.map((status, key) => (
        ...
        <div className='flex justify-center flex-col gap-2 items-center w-1/5 relative px-8'>
          ...
          <Image src='/images/image4.jpg' alt='baner image' width={500} height={300} className='max-w-80 rounded-2xl shadow-2xl mr-0 sm:mr-22' />
        </div>
      </div>
    </div>
  )
